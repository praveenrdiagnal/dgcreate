...
class ToogleItem extends React.Component {
  constructor() {
    ...
    this.handleAssetOnHover = this.handleAssetOnHover.bind(this);
  }

  handleAssetOnHover(e) {
    console.log("make me focussed", e.target.focus())    
  }
  ...
  render() {
    return (
      <Focusable 
        ...
        onClick={(e) => this.handleAssetOnHover(e)} 
      >
        <div
       
          class={'item ' + (this.state.active ? 'item-focus' : '')} 
          style={{ backgroundImage: `url('https://placeimg.com/1000/700/people')`}}
        />
      </Focusable>
    );
  }
